...
const sectors = [
  {color:"#f82", label:"Historia", image: setImageUrl(urlimg) },
  {color:"#8cfc03", label:"Geografía", image: setImageUrl(urlimg) },
  {color:"#00bd94", label:"Matemática", image : setImageUrl(urlimg)},
  {color:"#3141eb", label:"Matemática", image : setImageUrl(urlimg)},
  {color:"#fb0", label:"Matemática", image : setImageUrl(urlimg)},
  {color:"#f82", label:"Matemática", image : setImageUrl(urlimg)},
  // {color:"#0fb", label:"50"},
  // {color:"#b0f", label:"100"},
  // {color:"#f0b", label:"5"},
  // {color:"#bf0", label:"500"},
